...
SECRET_KEY = 'django-insecure-+cdd!@3rymxcd4cujlbn0p=^xak^rze&7&e0wk1eplx4z6ypp_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["portfolio-management-3.onrender.com",
...
# Optional (recommended if you already have a static folder)
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
